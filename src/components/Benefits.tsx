...
const benefits = {
  en: [
    ...
    },
    {
      ...
      description: "$15/sessiya for quality work, with weekly payments",
      icon: DollarSign
    },
    {
  ...
  uz: [
    ...
    },
    {
      ...
      description: "Sifatli ish uchun sesiyasiga $15",
      icon: DollarSign
    },
    {
  ...
  kz: [
    ...
    },
    {
      ...
      description: "Сапалы жұмыс үшін $15/sessiya",
      icon: DollarSign
    },
    {
      title: "Тұрақты Табыс",
  ...
  ru: [
    ...
    },
    {
      ...
      description: "$15/sessiya за качественную работу",
      icon: DollarSign
    },
    {
